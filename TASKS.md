...
### T-101 · SpacerQuest invariant predicates — `status: TODO` · `coder: opus` · `after: —`
...
### T-201 · verify_round1.py — one full day-loop campaign + invariants + determinism — `status: TODO` · `coder: opus` · `after: T-101`
