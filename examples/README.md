...
| [**sokoban**](sokoban/README.md) | Sokoban Mini — push three levels' worth of crates onto targets | Godot 4 | `custom` (TCP, hand-written adapter) | 105/105 | 18 · 11 · 14 · 15 · 7 | local stage done — transport proven, model below the floor; paid run not started |
